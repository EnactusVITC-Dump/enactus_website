  ...
  return (
    ...
    >
      ...
      <div className="hidden md:block w-full relative pointer-events-none my-0 z-20 overflow-visible">
        <svg className="w-full h-auto drop-shadow-xl" preserveAspectRatio="xMidYMid meet" viewBox="-120 -20 1920 480">
          <path id="wavePathDesktop" d="M -120 180 C 220 20, 520 420, 820 300 S 1350 20, 1800 180" fill="transparent" stroke="#F5C842" strokeWidth="80" strokeLinecap="round" strokeLinejoin="round" />
          <text>
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative pb-0 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center lg:items-start relative">
          ...
          <div className="flex flex-col items-center lg:items-end w-full relative h-auto z-10 pr-0 lg:pr-8">
            <div className="relative mb-8 w-full flex justify-center lg:justify-end">
              ...
              <svg className="absolute top-[30px] right-[40px] w-[150px] h-[150px] pointer-events-none z-0 overflow-visible hidden lg:block" viewBox="0 0 150 150">
            ...
            <div className="flex flex-col gap-8 items-end w-full max-w-[280px] relative z-10 pt-8 pb-4">
              {/* MAIL */}
              <MagneticButton href="mailto:contact@enactusvitc.org" className="w-[220px] h-[55px] bg-white rounded-full border-2 border-black shadow-lg flex items-center justify-between px-6 hover:bg-gray-100 transition-all duration-300 self-center lg:self-end transform rotate-[-15deg] hover:rotate-0 lg:mr-10">
                <span className="font-bebas text-[#000000] text-[20px] tracking-wider pt-1">MAIL</span>
                <MailIcon />
              </MagneticButton>

              {/* LINKEDIN */}
              <MagneticButton href="#" className="w-[220px] h-[55px] bg-white rounded-full border-2 border-black shadow-lg flex items-center justify-between px-6 hover:bg-gray-100 transition-all duration-300 self-center lg:self-end transform rotate-[-15deg] hover:rotate-0 lg:mr-2">
                <span className="font-bebas text-[#000000] text-[20px] tracking-wider pt-1">LINKEDIN</span>
                <LinkedinIcon />
              </MagneticButton>

              {/* INSTAGRAM */}
              <MagneticButton href="#" className="w-[220px] h-[55px] bg-white rounded-full border-2 border-black shadow-lg flex items-center justify-between px-6 hover:bg-gray-100 transition-all duration-300 self-center lg:self-end transform rotate-[-15deg] hover:rotate-0 lg:mr-10">
      ...
      {/* Bottom Bar */}
      <div className="bg-transparent border-t border-[rgba(245,200,66,0.2)] pt-8 pb-16 w-full relative z-20 mt-8">
