  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url("/src/assets/images/paper_texture_1781015349785.png")`,
      ...
      <div className="max-w-[1200px] w-full mx-auto px-6 sm:px-12 relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <div className="flex flex-col items-center w-full max-w-[280px] sm:max-w-[320px]">
            ...
            >
              <img
                src="/src/assets/images/artisan_portrait_1781015651521.png"
          ...
          <div className="flex flex-col items-center w-full max-w-[280px] sm:max-w-[320px]">
            ...
            >
              <img
                src="/src/assets/images/artisan_hands_1781015631507.png"
